...
@Component({
  selector: 'app-zaboravi-lozinku2',
  templateUrl: './zaboravi-lozinku2.component.html',
  styleUrls: ['./zaboravi-lozinku2.component.scss'],
})
export class ZaboraviLozinku2Component implements OnInit {
